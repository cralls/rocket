...
$apiId = "bbe649ad-a341-4fa7-9e50-3ab85f85a737";
$apiKey = "fovqTrsbNpZ80DwoizzmLGBGgpsX2yimTOtexw0IcKk1kjzeXjHUHTI0io68Vrh7zCzs+8kAL1rHbGnmmObFQ==";
...
function addPurchaseLineXml($lines, $lineNumber, $productCode, $qty, $price, $taxRate) {
	...
	$tax->addChild('TaxRate', $taxRate);	
        ...
        function testPostNewSalesInvoiceXml() {
		    ...
		    $invoice->OrderStatus = "Placed";
		    $invoice->Customer->CustomerCode = "223";
		    $invoice->Currency->CurrencyCode = "USD";
		    $invoice->Warehouse->WarehouseCode = "USA1";
		    $invoice->Tax->TaxCode = $taxCode;
		
		    $lines = $invoice->addChild('SalesOrderLines');
		    addSalesInvoiceLineXml($lines, 1, 'DOME-01-BK', 1, 10, $taxRate);
				
		    $invoice->SubTotal = 10.00;
		    $invoice->TaxTotal = 1.50;
		    $invoice->Total = 11.50;	
